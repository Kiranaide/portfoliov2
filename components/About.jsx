...
const About = () => {
  return (
    <div className="max-h-[800px] relative overflow-hidden my-16 bg-white flex flex-row">
      <div className="pb-8">
      ...
      <div className="z-10 absolute flex items-center justify-center inset-0">
        <div className="bg-red-ruby text-almost-white p-8 sm:p-20 flex flex-col text-center space-y-4 max-w-sm md:max-w-5xl animate-popUpReverse hover:animate-popUp">
          <Image
            src="/red-star.svg"
            width={128}
            height={128}
      ...
      <div className="absolute flex items-center justify-center inset-0">
        <div className="bg-black max-w-sm md:max-w-5xl p-8 sm:p-20 flex flex-col text-center space-y-4">
          <h5 className="bold-16 sm:bold-32">About Me</h5>
          <p className="regular-14 sm:regular-24">
            A Front-end Enthusiast with a strong passion for Front-End
            Development, specializing in the creation of visually appealing and
